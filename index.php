...
<body>
    ...
    <header class="container-fluid sticky-top">
        ...
        <div class="container-navbar d-flex">
            <ul class="d-flex list-unstyled">
                ...
                <li class="px-3">
                    <a class="fw-light" href="#">Introduzione</a>
                </li>
                <li class="px-3">
                    <a class="fw-light" href="#">Norme sulla privacy</a>
                </li>
                <li class="px-3">
                    <a class="fw-light" href="#">Termini di servizio</a>
                </li>
                <li class="px-3">
                    <a class="fw-light" href="#">Tecnologie</a>
                </li>
                <li class="px-3">
                    <a class="fw-light" href="#">Domande frequenti</a>
                </li>
    ...
    <main class='container mb-4'>
        ...
        foreach ($faqs as $section) {
            ...
            echo "<h2>{$section['title']}</h2>";                  // print titles

            foreach ($section['paragraph'] as $paragraph) {

                echo "<p>{$paragraph}</p>";                   // print paragraphs
